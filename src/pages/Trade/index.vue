  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ finalAddress.fullAddress }}</span>
        收货人：<span>{{ finalAddress.consignee }}</span>
        <span>{{ finalAddress.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  mounted() {
    this.$store.dispatch("tradeInfo/findUserAddressList");
    this.$store.dispatch("tradeInfo/getTrade");
  },
  computed: {
    ...mapState("tradeInfo", ["AddressList", "tradeList"]),
    finalAddress() {
      return (
